...
var Component = function (_React$Component) {
  ...
  function Component() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Component.__proto__ || Object.getPrototypeOf(Component)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      query: '',
      items: ["Man in the High Castle", "The Expanse", "Silicon Valley", "Daredevil", "The Punisher", "Stranger Things"],
      filtered: [],
      showList: false
      ...
      _this.setState({
        filtered: _this.state.items.filter(function (item) {
          return item.toLowerCase().indexOf(query.toLowerCase()) !== -1;
        }),
        showList: _this.shouldShowList()
      });
    }, _this.handleFocus = function () {
      _this.setState({
        showList: _this.shouldShowList()
      });
    }, _this.shouldShowList = function () {
      return _this.state.filtered.length > 0;
  ...
  _createClass(Component, [{
    ...
    value: function render() {
      var list = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('ul', { style: {
          margin: 0,
          listStyle: 'none',
          border: '1px solid',
          padding: '5px',
          boxSizing: 'border-box' } }, this.state.filtered.map(function (item) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('li', { key: item }, item);
      }));

      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', {
        style: { width: 200, padding: '15px 15px 0' } }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__component__ = __webpack_require__("./src/js/component.jsx");
...
var tags = document.getElementsByTagName('component');

console.log('tags: ', tags);

for (var i = 0; i < tags.length; i++) {
  __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__component__["default"], null), tags[i]);
}
...
module.exports = __webpack_require__("./src/js/components.jsx");
